...
public class Geolocalisation
{
	...
	public static int[] getDistance(GeoPosition Pos1, GeoPosition Pos2)
	{
		...
		try
		{
			...
			url="http://www.yournavigation.org/api/1.0/gosmore.php?format=kml&flat=33.676610&flon=-7.381590&tlat=31.901998&tlon=-7.941965&v=motorcar&fast=1&layer=mapnik";
			DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
			DocumentBuilder db = dbf.newDocumentBuilder();
			Document doc = db.parse(new URL(url).openStream());
			doc.getDocumentElement().normalize();
	...
	public static List<GeoPosition> getRouting(GeoPosition Pos1, GeoPosition Pos2)
	{
		...
		try
		{
			String url = "http://www.yournavigation.org/api/1.0/gosmore.php?format=kml&flat=" + Pos1.getLatitude()
					+ "&flon=" + Pos1.getLongitude() + "&tlat=" + Pos2.getLatitude() + "&tlon=" + Pos2.getLongitude()
					+ "&v=motorcar&fast=1&layer=mapnik";
			url="http://www.yournavigation.org/api/1.0/gosmore.php?format=kml&flat=33.708634&flon=-7.401846&flat=33.706904&flon=-7.402156&tlat=31.901998&tlon=-7.941965&v=motorcar&fast=0&layer=mapnik";
