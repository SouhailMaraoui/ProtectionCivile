...
public class Casernes
{
	...
	public static JButton Localosation;
	//public static JButton Ressources;
	...
	public static JPanel Init()
	{
		...
		Casernes.add(GUI.NewLabel("Localisation :", 20, 820, 810));
		Localosation = GUI.NewButton("Localiser", new Color(100, 150, 215), 20, 220, 40, 800, 850);
			...
			public void mousePressed(MouseEvent e)
			{
				...
				if (isInt(NTelephone) && Nom.length() > 0 && rue.length() > 0 && commune.length() > 0)
				{
					try
					{
						...
						//Ressources.setText("Ajouter des Ressources");
						Localosation.setText("Localisation du Caserne");
						connection.commit();
						Tele.setText("");
						Name.setText("");
					} catch (Exception ex)
