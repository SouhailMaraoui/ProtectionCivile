...
public class Login
{
	...
	public static void init()
	{
		...
		frame.add(GUI.NewLabel("Nom d'utilisateur", 22, 282, 80));
		frame.add(GUI.NewLabel("Mot de Passe", 22, 282, 130));
		...
		JButton login = GUI.NewButton("Connexion","res/User/Login/LoginIcon.png", 25, 250, 40, 325, 250);
		frame.add(login);
