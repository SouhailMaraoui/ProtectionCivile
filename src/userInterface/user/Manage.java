...
public class Manage
{
	...
	public static JPanel Init()
	{
		...
		table.setFont(new Font("Century Gothic", Font.PLAIN, (int) (scaley* 16)));
		...
		BWaiting = GUI.NewButton("En attente", "res/User/Manage/WaitingIcon.png",25, 225, 40, 170, 250);
		Manage.add(BWaiting);
		JButton BStart = GUI.NewButton("Traiter", Color.GRAY, 22, 200, 40, 700, 750);
		BInProgress = GUI.NewButton("En cours","res/User/Manage/ProgressIcon.png", Color.GRAY, 25, 225, 40, 390, 250);
		Manage.add(BInProgress);
		JButton BFinish = GUI.NewButton("Est Résolue", Color.GRAY, 22, 200, 40, 700, 750);
		BDone = GUI.NewButton("Traité","res/User/Manage/ResolvedIcon.png", Color.GRAY, 25, 200, 40, 590, 250);
		Manage.add(BDone);
		...
		JButton Back = GUI.NewButton("Retour","res/User/Manage/ReturnIcon.png", Color.black, 22, 200, 40, 400, 800);
		Manage.add(Back);
