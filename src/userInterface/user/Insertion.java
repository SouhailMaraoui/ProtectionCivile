...
public class Insertion
{
	...
	public static JPanel Init()
	{
		...
		JButton BInsert = GUI.NewButton("Insérer","res/User/Insert/InsertIcon.png", 25, 200, 40, 170, 800);
		Insertion.add(BInsert);
		JButton BMap = GUI.NewButton("Localiser","res/User/Insert/MapIcon.png", Color.GRAY, 23, 220, 40, 370, 800);
		Insertion.add(BMap);
		JButton Clear = GUI.NewButton("Effacer","res/User/Insert/ClearIcon.png", Color.gray, 23, 200, 40, 590, 800);
		Insertion.add(Clear);
			...
			public void mouseClicked(MouseEvent arg0)
			{
						...
						&& rue.length() > 0 && commune.length() > 0)
				{
					try
					{
						...
						Incident.insert(strDate, 1, emplacement, rue, commune, IdVille,
		...
		JButton Back = GUI.NewButton("Retour","res/User/Insert/ReturnIcon.png", Color.black, 23, 250, 40, 375, 850);
		Insertion.add(Back);
