...
public class Incident
{
	...
	public static ResultSet GetIncidentByState(String etat)
	{
		...
		try
		{
			String query = "SELECT IdIncident,dateoccurrence,Emplacement,Rue,Commune,ville.nom as Ville FROM incident, ville where ville.idville=incident.idville and etat='"
					+ etat + "';";
			Statement statement = (Statement) connection.createStatement();
			ResultSet resultSet = statement.executeQuery(query);
			return resultSet;
	...
	public static ResultSet GetFinishedIncident()
	{
		...
		try
		{
			String query = "SELECT IdIncident,dateoccurrence,daterésolution,Emplacement,Rue,Commune,ville.nom as Ville FROM incident, ville where ville.idville=incident.idville and etat='Traité';";
			Statement statement = (Statement) connection.createStatement();
			ResultSet resultSet = statement.executeQuery(query);
			return resultSet;
		} catch (Exception e)
